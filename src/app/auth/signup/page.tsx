        ...
        <div className="flex-1 flex items-start lg:items-center justify-center px-6 py-8 bg-gray-50">
          <div className="w-full max-w-sm">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 font-medium h-11 px-4 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm"
            >
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link href={`/auth/signin?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-brand hover:text-brand-hover font-medium">
                Sign in
              </Link>
            </p>
          </div>
